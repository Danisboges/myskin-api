...
const patients = [
  {
    ...
    imageUrl: '/uploads/scan_1778915359021_vo59yy3mr.jpeg',
  ...
  {
    scanId: 'SCAN-SEED-001-FEB',
    caseId: 'SK-9921-FEB',
    email: 'sarah.johnson@example.com',
    name: 'Sarah Johnson',
    gender: 'female',
    birthDate: new Date('1984-02-11'),
    imageUrl: '/uploads/scan_1778915076864_4g16q1pd9.jpeg',
    bodySite: 'Left Shoulder',
    complaint: 'Baseline photo of the same spot before visible color change.',
    notes: 'Initial baseline capture for lesion monitoring.',
    aiPrediction: 'Melanocytic Nevus',
    aiConfidence: 0.8,
    aiDetails: [
    ...
    caseReview: {
      zoom: '3.5x',
      light: 'Natural',
      physicianObservation: 'Baseline image shows a small symmetric pigmented lesion without suspicious border changes.',
      finalDiagnosis: 'Melanocytic Nevus',
      reviewStatus: 'approved',
      receivedAt: new Date('2026-02-18T09:15:00Z'),
      reviewedAt: new Date('2026-02-18T10:00:00Z'),
    },
    observation: 'Baseline scan captured for future comparison.',
  },
  {
    scanId: 'SCAN-SEED-001-MAY',
    caseId: 'SK-9921-MAY',
    email: 'sarah.johnson@example.com',
    name: 'Sarah Johnson',
    gender: 'female',
    birthDate: new Date('1984-02-11'),
    imageUrl: '/uploads/scan_1779229491492_aw5cbg78q.png',
    bodySite: 'Left Shoulder',
    complaint: 'Follow-up scan after noticing the spot became slightly darker.',
    notes: 'Patient reports subtle darkening compared with prior month.',
    aiPrediction: 'Melanocytic Nevus',
    aiConfidence: 0.91,
    aiDetails: [
    ...
    caseReview: {
      zoom: '4.0x',
      light: 'Polarized',
      physicianObservation: 'Follow-up image remains consistent with benign nevus. Slight color variation noted but no high-risk features.',
      finalDiagnosis: 'Melanocytic Nevus',
      reviewStatus: 'approved',
      receivedAt: new Date('2026-05-12T08:45:00Z'),
      reviewedAt: new Date('2026-05-12T09:35:00Z'),
    },
    observation: 'Continue monthly monitoring and sun protection.',
  },
  {
...
async function upsertCaseReview(patient, scan, doctorProfileId) {
  const caseReviewData = {
    ...
    createdAt: patient.caseReview.createdAt || patient.caseReview.receivedAt,
  };
